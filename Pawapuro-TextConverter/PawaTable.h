...
//ログレベル・・・0で必ず表示、2でverbose
 static const std::unordered_map<u16, std::tuple<int, std::string, int, int > > TBL_successcommand{
	...
	{0x000A ,{1, "[0x0A:", 0, 2}}, {0x000B ,{1, "[Goto:", 0, 1}}, 
	{0x000C ,{1, "[Gosub:", 0, 1}}, {0x000D ,{1, "[選択肢:", 0, 1}}, {0x000E ,{2, "[分岐:", 0, 2}}, 
	{0x0024 ,{0, "[0x24]", 0, 2}},
	{0x002F, {1, "[0x2F:", 0, 2}},
	{0x0031 ,{0, "[主人公]", 3, 0}},{0x0032 ,{1, "[左1顔:", 0, 1}}, {0x0033 ,{1, "[左2顔:", 0, 1}}, 
	{0x0034 ,{1, "[右1顔:", 0, 1}}, {0x0035 ,{1, "[右2顔:", 0, 1}}, 
	{0x0039 ,{1, "[背景:", 0, 1}}, {0x003A ,{1, "[音:", 0, 1}},
